...
export const MATERIAL_CONFIG = {
  ...
  resonance: { name: '共鳴', symbol: '◎', color: '#a78bfa', surface: '#ede9fe', description: '左右鄰骰面本回合基礎攻擊各 +2。' },
  ...
  foil: { name: '亮金箔', symbol: '▧', color: '#eab308', surface: '#fef08a', description: '有效基礎攻擊 +3。' },
  negative: { name: '負片', symbol: '◐', color: '#e2e8f0', surface: '#1e293b', description: '基礎攻擊 +5；結算後 -2，最低為基礎攻擊力 0，下場戰鬥重置。' },
