...
export const MONSTER_CONFIG: readonly EnemyDefinition[] = [
  ...
  monster(2, 'veteran', '水草浪人', 'normal', ['retaliation'], 55, 20, [{ ...attack(4), name: '迎擊架勢', retaliate: { hits: 5, damage: 5 } }, shieldStrike(10), rest]),
  monster(2, 'elite', '爛泥重盾鱷', 'elite', ['shieldPower', 'shieldHeal'], 80, 25, [{ ...attack(8), name: '重盾壓制', shieldMultiplier: 2 }, swallow(20, 2), defend(25), attack(7)]),
  monster(2, 'waterway_bully', '水路鱷霸', 'boss', ['grapple', 'shieldPower'], 125, 35, [{ ...attack(10), name: '鎖鏈鉤索', grapple: 7 }, { ...attack(10), name: '持盾重擊', shieldMultiplier: 2 }, defend(25), rest]),
  ...
  monster(3, 'veteran', '黑市老鱷', 'normal', ['potion'], 135, 0, [{ type: 'rest', name: '黑市藥劑', heal: { amount: 30, uses: 1 } }, attack(8)]),
  ...
  monster(4, 'elite', '鱷魚人侍衛長', 'elite', ['shieldPower', 'defense'], 250, 30, [{ ...attack(8), name: '持盾強襲', shieldMultiplier: 2 }, strike(20, 90, 'cancel'), defend(30), rest]),
  monster(4, 'boss', '害鱷將軍', 'boss', ['exposed'], 360, 30,
    [attack(10), { type: 'heavy_attack', name: '重斬', value: 16 }, expose(attack(10), 1.75), rest]),
  monster(5, 'jailer', '鱷魚人囚徒', 'normal', ['defense'], 190, 0, [attack(7), defend(15, 100), rest]),
  monster(5, 'armored', '資深鱷囚', 'normal', ['shieldHeal'], 165, 45, [shieldStrike(16), swallow(30, 2), attack(7)]),
  ...
  monster(6, 'elite', '鱷魚人親衛', 'elite', ['shieldPower', 'multihit', 'guardedFollowup'], 440, 60, [{ ...attack(11), name: '持盾穿刺', shieldMultiplier: 2 }, combo(8, 3, 0.5), strike(24, 155), rest]),
