...
export const CREATURE_CONFIG: Record<CreatureId, CreatureDefinition> = {
  ...
  sisters: role('土人姐妹花', '👭', ['common'], '互相提攜', `場上至少有 ${b.sisters.minimum} 名姐妹花時，基礎攻擊力 ×${b.sisters.multiplier}。`),
  twins: role('土人雙胞胎', '👯', ['common'], '頂替上場', '本回合攻擊力提升至同骰雙胞胎的最高基礎攻擊力。'),
  ...
  loner: role('土人獨行俠', '🧥', ['warrior'], '孤獨一匹狼', `同骰中沒有其他土人獨行俠時，基礎攻擊力 ×${b.loner.multiplier}。`),
  chef: role('土人廚師', '👨‍🍳', ['craftsman'], '加菜', '同骰擲出 [食物] 時存入儲糧；自身擲出時，消耗所有儲糧轉為等值追加攻擊。'),
  porter: role('土人搬運工', '📦', ['craftsman'], '接力', '加上同一連線中，前方所有搬運工的基礎攻擊力。'),
  ...
  thief: role('土人毛賊', '🥷', ['common'], '趁火打劫', '本回合若發生搶奪，追加一次等同基礎攻擊力的攻擊。'),
