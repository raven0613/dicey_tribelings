...
export const CREATURE_CONFIG: Record<CreatureId, CreatureDefinition> = {
  ...
  sisters: role('土人姐妹花', '👭', ['common'], '互相提攜', `骰出至少 ${b.sisters.minimum} 名土人姐妹花時，每名攻擊力 +${b.sisters.bonus}，再加自身基礎值 × 其他姐妹人數 × ${b.sisters.perSister}。`),
  ...
  porter: role('土人搬運工', '📦', ['craftsman'], '接力', `與其他土人搬運工相連時，隊尾額外攻擊＝自身基礎值 ×（其他隊員數 × ${b.porter.linear} + 其他隊員數² × ${b.porter.chainGrowth}）。`),
