    ...
    <svg viewBox="0 0 100 104" aria-hidden="true" className="battle-die-art"
      ...
      <defs>
        <linearGradient id={`${id}-rim`} x1="0" y1="0" x2="0.75" y2="1">
          <stop stopColor="#fff5d6" /><stop offset="0.48" stopColor={creature.color} /><stop offset="1" stopColor="#334155" />
        </linearGradient>
      ...
      {protectedDie && <text x="50" y="29" textAnchor="middle" fontSize="12">🛡</text>}
      {face.temporarySticker && <circle cx="50" cy="33" r="3" fill="#e11d48" stroke="#fff" strokeWidth="1.5" />}
    </svg>
  </button>;
};
